(function(){
    ...
    loc1Form.addEventListener('submit', function (event) {
        ...
        if (loc1Key.value.toLowerCase() === 'shovel') {
            window.location.href = 'https://ericawithac.github.io/des157b/capstone/development/usability/location/arboretum-gateway-garden.html';
        }
        else {
    ...
    loc2Form.addEventListener('submit', function (event) {
        ...
        if (loc2Key.value.toLowerCase() === 'cow') {
            window.location.href = 'https://ericawithac.github.io/des157b/capstone/development/usability/location/the-silo.html';
        }
        else {
    ...
    loc3Form.addEventListener('submit', function (event) {
        ...
        if (loc3Key.value.toLowerCase() === '10' || loc3Key.value.toLowerCase() === 'ten') {
            window.location.href = 'https://ericawithac.github.io/des157b/capstone/development/usability/location/sprocket-bike-tunnel.html';
        }
        else {
    ...
    loc4Form.addEventListener('submit', function (event) {
        ...
        if (loc4Key.value.toLowerCase() === 'bike' || loc3Key.value.toLowerCase() === 'bicycle') {
            window.location.href = 'https://ericawithac.github.io/des157b/capstone/development/usability/location/the-big-bike.html';
        }
        else {
    ...
    loc5Form.addEventListener('submit', function (event) {
        ...
        if (loc5Key.value.toLowerCase() === 'dome') {
            window.location.href = 'https://ericawithac.github.io/des157b/capstone/development/usability/location/baggins-end-domes.html';
        }
        else {
    ...
    window.addEventListener('load', function(event) {
        alert("You are a new resident of Davis and want to learn more about the city's history and landmarks as well as explore the city using the Davis Bike Loop. A local resident tells you about this web app so you opened it on your browser. Read about the app and then see if you can find out more about one of the locations on the Bike Loop. Do what the app prompts you to do.");
    })
}());